...
def create_custom_component(Component, State):
    ...
    def entry(props):
        ...
        effect = Object("function (effect, cleanup) {return function () {effect(%s);return function () {cleanup(%s)}}}" % (id.toString(), id.toString())).call(functions.mount if step == 0 else functions.update, functions.unmount)
